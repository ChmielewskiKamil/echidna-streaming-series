...
contract EchidnaTemplate {
    ...
    // Uses functions from the library under test!
    function significant_digits_lost_in_mult(int128 a, int128 b)
        private
        returns (bool)
    {
        int128 x = a >= 0 ? a : -a;
    ...
    // Uses functions from the library under test!
    function significant_bits_after_mult(int128 a, int128 b)
        private
        returns (uint256)
    {
        int128 x = a >= 0 ? a : -a;
    ...
    // Uses functions from the library under test!
    function most_significant_bits(int128 n, uint256 i)
        private
        returns (uint256)
    {
